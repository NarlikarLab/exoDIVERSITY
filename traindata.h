...
int sampleStartPosn(model*, dataSet*, int, int, unsigned int*, int, int, int, int, double*, double*, double*);
int sampleLabel(model*, dataSet*, int*, int, unsigned int*, int, int, double*, double*, double*,int);
void updateReadsStartPos(model*, int*, int*, int, int, int);
void takeExp(double*, int*, int);
int getMax(double*, int*, int);

int sampleMotifWidthRight(dataSet*, model*, int*, int*, int*, int, int, int, double**, double**, double**, int, int, unsigned int*,int);
int sampleMotifWidthLeft(dataSet*, model*, int*, int*, int*, int, int, int, double**, double**, double**, int, int, unsigned int*,int);
...
trainOut *trainData(dataSet*, int, float, float*, unsigned int, double**, double**, double**, int*, int,int,int,int,int,int,int,char*,char*);

double updateBestModel(model*, dataSet*, int*, int*, int*, int*, double**, double**, double**, double, int,int,int,int, FILE*, int);
