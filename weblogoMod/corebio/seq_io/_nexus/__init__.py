...
from weblogoMod.corebio.seq import Seq, Alphabet, protein_alphabet
import weblogoMod.corebio.data as data
from weblogoMod.corebio.utils import Struct
